...
public class BoardController {
   ...
   public void get(@RequestParam("adno") Long adno, Model model, @ModelAttribute("cri") Criteria cri) {
   ...
   public String add(AdminBoardVO adminboard,MultipartHttpServletRequest request1) {
      ...
      apicture=apicture.replace("C:\\lacture\\final\\a_finalproject3\\src\\main\\webapp\\resources\\img\\","");
