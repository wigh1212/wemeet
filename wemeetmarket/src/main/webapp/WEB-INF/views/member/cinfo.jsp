    ...
    <div class="container">
        ...
        <form action="update" method="POST" id="minfoWrapper" enctype="multipart/form-data" >
            ...
            <ul>
              ...
              <input name="mphone" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" name="mphone"   class="form-control" id="inputPhone1"  maxlength="3" placeholder="010" value="${member.mphone }">

                <input name="mphone1" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" name="mphone1" class="form-control" id="inputPhone2"  maxlength="4" placeholder="0000" value="${member.mphone1 }">

                <input name="mphone2" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" name="mphone2" class="form-control" id="inputPhone3"  maxlength="4" placeholder="0000" value="${member.mphone2 }">
				</li>
                <li>
                ...
                <li>
                    ...
                    <input class="form-control  col-md-3" name="mpost" type="text" id="postcode"
                        value="${member.mpost}" readonly>
		...
		if(data==1){
			...
			if(pw==null || pw !== pw1 ){
				...
				if(pw.length<6){
					...
					if(mphone.length<2 && mphone1.length<4 && mphone2.length<3){
